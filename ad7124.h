...
/**
  ...
  * @return 0 for success or negative error code
  */
int setAdcControl (OperatingMode mode, PowerMode power_mode, bool ref_en , ClkSel clk_sel );
...
/**
  ...
  * @return 0 for success or negative error code
  */
int setConfig (uint8_t cfg, RefSel ref, PgaSel pga, bool bipolar, BurnoutCurrent burnout);
...
/**
  ...
  * @return 0 for success or negative error code
  */
int setConfigFilter (uint8_t cfg, FilterType filter, uint16_t fs,
                      PostFilterType postfilter,
                      bool rej60 , bool single);
...
/**
  * @brief Proceed to System zero-scale and full-scale calibration
  * @param ch channel number
  * @return 0 for success or negative error code
  */
int systemCalibration (uint8_t ch);
...
/**
 * @brief IntCalibration function is used to perform internal calibration for enabled channels
 * @param exciCurrent - user selected excitation current
